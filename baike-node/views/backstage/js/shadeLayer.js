...
(function($) {
    ...
    hint.prototype= {
        initialize:function (){
            var _this=this;
            $(this.modle_box).css({"opacity":"0","position":"fixed", "top":"10%", "left":"50%", "z-index":"9999","width":"600px","color":"#666666" ,"background":"#fff", "height":"60px", "margin-top":"-157px", "margin-left":"-230px","font-size": "14px","box-shadow": "0 0 20px 0 rgba(0,0,0,0.50)","line-height":"60px","text-align":"center"});
