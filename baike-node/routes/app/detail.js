...
router.get('/', function(req, res, next) {
    ...
    var testUrl=httpUrl+'/work/detail?'+'workSeqNo='+url.parse(req.url,true).query.id+'&registerId='+registerId+'&ip='+getClientIp(req)+'&userAgent='+userAgentInfo+'&referer='+getReferer(req);
